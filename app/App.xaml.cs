...
namespace QuierobesarteApp
{
    ...
    {
        public static decimal CurrentVersion = 1.0M;
        //internal const string baseUrl = "10.0.2.18:8001";
        internal const string baseUrl = "quierobesarte.es.nt5.unoeuro-server.com";
        ...
        {
            IsolatedStorageSettings.ApplicationSettings["AppModel"] = null;
        ...
        private static async System.Threading.Tasks.Task Navigate()
        {
            ...
            {
                appModel = (AppModel)IsolatedStorageSettings.ApplicationSettings["AppModel"];
            }
            ...
            if (appModel != null)
            {
                ...
                navigationUrl = new Uri("/Views/UploaderPage.xaml?weddingId=" + appModel.CurrentWedding.Id, UriKind.Relative);
            }
            else
            {
